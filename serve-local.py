...
# Align with _redirects: unpublished creator subsites → fuyuu
TEMP_REDIRECT_PREFIXES = (
    "/koharu",
    "/shiotsuki",
    "/tianhu",
)
...
def resolve_temp_redirect(clean: str) -> str | None:
    for prefix in TEMP_REDIRECT_PREFIXES:
...
class NoCacheHandler(SimpleHTTPRequestHandler):
    def _maybe_redirect(self) -> bool:
        ...
        dest = resolve_temp_redirect(clean)
        if not dest:
            return False
