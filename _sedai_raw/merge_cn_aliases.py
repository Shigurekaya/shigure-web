...
EXTRA: dict[str, list[str]] = {
    ...
    "euphoria": ["Euphoria", "Euphoria -Kindan no Euphoria-", "エウフォリア"],
    "STARLESS": ["Starless", "Starless ~Nihonban~", "スターレス"],
    "戈尔尖叫秀": ["Gore Screaming Show", "ゴア・スクリーミング・ショウ", "GSS"],
    "狂嗜之血": ["SaDistic BlooD", "Sadistic Blood", "サディスティック・ブラッド"],
    "DIVI-DEAD": ["Divi-Dead", "ディヴィ・デッド"],
